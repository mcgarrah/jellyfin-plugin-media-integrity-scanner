...
- [ ] **Deduplicate the shared JavaScript in `Web/*.html` into one embedded script resource.**
...
- [ ] **Add a single server-side validation choke point for `PluginConfiguration`.**
